package siberteam.testperiod.mt2.second.factory;

import siberteam.testperiod.mt2.second.annotation.SorterInfo;
import siberteam.testperiod.mt2.second.data.SorterData;
...
public class SorterFactory {
    private static final String PACKAGE_NAME = "siberteam/testperiod/mt2/second/sorter";
    ...
    public Set<Sorter> getAllInstances() {
        Set<Sorter> sortersSet = new HashSet<>();
        for (String className : sorters.keySet()) {
            sortersSet.add(getInstance(className));
        }
        return sortersSet;
    }
}
